...
#------------------------------------------------HOW TO USE--------------------------------------------------
#1. Find the input file/s you want 
#2. Go to the end of the file and fill in the num_resources, num_areas, num_timeslots, num_resource_types for that input 
#3. Run the script
#------------------------------------------------------------------------------------------------------------
parsed = parser('input/K07_F02_NUOF_IA_25_I01.dat')
parsed1 = parser('input/K07_F02_NUOF_IA_25_I02.dat')
parsed2 = parser('input/K07_F02_NUOF_IA_25_I03.dat')
#------------------------------------------------INPUT DATA--------------------------------------------------

def optimiser(parsed, num_resources, num_areas, num_timeslots, num_resource_types):
    ...
    return TD/1000, TCmin/1000, WO_value/1000
...
TD25, TCmin25, WO25 = optimiser(parsed, num_resources=7, num_areas=2, num_timeslots=45, num_resource_types=2)
TD251, TCmin251, WO251 = optimiser(parsed1, num_resources=7, num_areas=2, num_timeslots=45, num_resource_types=2)
TD252, TCmin252, WO252 = optimiser(parsed2, num_resources=7, num_areas=2, num_timeslots=45, num_resource_types=2)

instanceTD = [TD25, TD251, TD252]
test = [1, 2, 3]

plt.plot(test, instanceTD)
plt.show()